...
import { Dialog, DialogContent, Select, InputLabel, MenuItem, Snackbar, Alert  } from '@mui/material'
...
const WorkersDashboard = () => {
  ...
  const getMonthInHebrew = (e) => {
    ...
    useEffect(() => {
      ...
      const getData = () => {
        const id = result?.subId
        return axios.get(`https://nartina.com/api/user/get-user-clocks/${id}/${page}/10/date`)
      }
    ...
    const getWorkers = () => {
        axios.get(`https://nartina.com/api/user/all-workers/${result?.subId}`)
      ...
      const startShift = (e) => {
        e.preventDefault();
        if(workerFullName == "בחר עובד" || workerFullName == "") {
          alert("יש לבחור עובד")
          return
        }
        setLoading(true)
        axios.post(`https://nartina.com/api/worker/start-shift/${result?.subId}/${workerId}`, {
        ...
        .then(res => {console.log(res.data)
          setOpenDialog(false)
          // setAlert1(true)
          Swal.fire("!כניסת עובד", '! עובד התחיל משמרת בהצלחה', "success");
          setWorkerFullName("")
          refetch()})
      ...
      const endShift = (id) => {
        setLoading(true)
        axios.post(`https://nartina.com/api/worker/end-shift/${id}`, {
        ...
        .then(res => {console.log(res.data)
          // setAlert2(true)
          Swal.fire("!יציאת עובד", '! עובד סיים משמרת בהצלחה', "success");
  ...
  return (
    ...
    <nav class="bg-gray-800 border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-900">
        <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            <a href="https://nartina.com/workers-page" class="flex items-center">
            ...
            <div class="flex items-center lg:order-2">
                ...
                <a href="#" class="text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800">הרשמה</a>
            ...
            <div class="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                    ...
                    <li>
                        <div onClick={()=> navigate("/workers-rosters")} class={`block cursor-pointer py-2 pr-4 pl-3 text-gray-400 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-blue-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700`}>סידור עבודה</div>
                    </li>
                    <li>
                        <div class={`block cursor-pointer py-2 pr-4 pl-3 text-white border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-blue-700 lg:p-0 dark:text-white lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700`}>שעון נוכחות</div>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <section class={`bg-gray-50 dark:bg-gray-900 pt-1 h-[90vh] overflow-y-auto scrollbar-none ${windowWidth < 766 && 'bg-gray-700 dark'} ${globalTheme != "light" && "bg-gray-700 dark"}`}>
{flag && (
  <>
        ...
        {errors == 403 && <div className='flex items-center justify-center text-center'>
          <Alert severity="error">יש לעשות יציאה ולהרשם שוב מטעמי בטיחות  
            ...
            <form onSubmit={startShift}>
                ...
                {!loading ? (
              <button type="submit" disabled={workerFullName == "" || workerFullName == "בחר עובד"} class="text-white inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                   כניסה 
              </button>
                ) : (
                  <button disabled type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 inline-flex items-center">

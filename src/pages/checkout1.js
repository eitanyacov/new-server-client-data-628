...
const Checkout1 = () => {
  ...
  return (
    <div className='h-screen w-full'>
        <Navbar/>
        <ol class="flex items-center w-full h-40 mt-10 px-8 fixed top-0 z-50 text-sm font-medium text-center text-gray-500 dark:text-gray-400 sm:text-base">
    ...
    <li class="flex items-center cursor-pointer">
        ...
        {/* <div class="flex flex-col items-center border-b bg-white py-4 sm:flex-row sm:px-10 lg:px-20 xl:px-32 mt-28"> */}
...
{state1 && (
  <>
  <div class="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32 mt-36">
  <div class="px-4 pt-8">
    <p class="text-xl font-medium text-right">סיכום הזמנה</p>
    <p class="text-gray-400 text-right">.עבור על ההזמנה לפני ביצוע התשלום</p>
    <div class="mt-8 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6">
      <div class="flex flex-col rounded-lg bg-white sm:flex-row">
        ...
        <div class="flex w-full flex-col items-end px-4 py-4">
          <span class="font-semibold text-right">Nike Air Max Pro 8888 - Super Light</span>
  ...
  <div class="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
    <p class="text-xl font-medium text-right">פרטי תשלום</p>
    <p class="text-gray-400 text-right">.השלם את ההזמנה ע"י מילוי פרטי התשלום</p>
    <div class="">
      <label for="email" class="mt-4 mb-2 block text-sm font-medium text-right">כתובת אימייל</label>
      <div class="relative">
      ...
      <label for="card-holder" class="mt-4 mb-2 block text-sm font-medium text-right">שם בעל הכרטיס</label>
      <div class="relative">
      ...
      <label for="card-no" class="mt-4 mb-2 block text-sm font-medium text-right">פרטי כרטיס</label>
      <div class="flex">
      ...
      <label for="billing-address" class="mt-4 mb-2 block text-sm font-medium text-right">כתובת דואר</label>
      ...
      <div class="mt-6 border-t border-b py-2">
        ...
        <p class="font-semibold text-gray-900">$399.00</p>
          <p class="text-sm font-medium text-gray-900">סיכום</p>
         
        </div>
        <div class="flex items-center justify-between">
        <p class="font-semibold text-gray-900">$8.00</p>
          <p class="text-sm font-medium text-gray-900">משלוח</p>
          
        </div>
      </div>
      <div class="mt-6 flex items-center justify-between">
      <p class="text-2xl font-semibold text-gray-900">$408.00</p>
        <p class="text-sm font-medium text-gray-900">סה"כ</p>
        
      </div>
    </div>
    <button class="mt-4 mb-8 w-full rounded-md bg-gray-900 px-6 py-3 font-medium text-white">בצע תשלום</button>
  </div>
</div>
  </>
)}

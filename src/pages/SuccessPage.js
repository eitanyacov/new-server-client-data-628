   ...
   {!UserEmail ? (
     ...
     <div class="mt-4">
        ...
        <p class="mt-4 text-sm">If you’re having trouble clicking the "Verify Email Address" button, copy
            ...
            <a href="https://nartina.com/login" class="text-blue-600">https://nartina.com/login</a>
        </p>
    </div>
    ...
    <div class="max-w-xl p-8 text-center text-gray-800 bg-white shadow-xl lg:max-w-3xl rounded-3xl lg:p-12">
    <h3 class="text-2xl">Thanks for signing up for nartina.com! <span>{CardOwnerName}</span></h3>
    <div class="flex justify-center">

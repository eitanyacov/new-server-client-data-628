...
const Chat = () => {
    ...
    const image = 'https://i.redd.it/iibrptucse951.png'

  return (
   <>
   <div style={{ backgroundImage: `url(${image})` }} class={`h-screen fixed top-14 -z-20 pt-[3px] pr-3 pl-1 bg-cover bg-center max-w-full ${hebrew ? 'airx:ml-64' : 'airx:mr-64'}`}>
      <section class="shadow-xl rounded-md w-full lg:w-11/12 flex">
        {/* <!-- Left section --> */}
        <div class="w-full h-[89vh] lg:w-4/6 md:w-2/6 flex flex-col overflow-y-auto scrollbar-thin justify-start items-stretch blue-glassmorphism rounded-md lg:rounded-none lg:rounded-l-md p-3">
          <div class="flex flex-row justify-between items-center mb-4 sticky top-0">
            ...
            <div class="flex-auto flex flex-row">
                  ...
                  <ul class="">
                    <li class="my-2 text-gray-900 cursor-pointer">
                      <button class="flex flex-col justify-center items-center w-full p-2 rounded-lg bg-gray-600 bg-opacity-10 focus:outline-none focus:ring relative">
                        ...
                        <span class="bg-blue-600 w-4 h-4 animate-pulse text-xs rounded-full text-white font-semibold absolute right-3 top-1">2</span>
                      </button>
                    </li>
              ...
              <div class="w-full p-1">
                ...
                <ul class="overflow-y-auto">
                  <li class="my-2 p-2 flex flex-row cursor-pointer rounded-lg hover:bg-gray-50 hover:bg-opacity-50" onClick={()=> navigate('/chat2')}>
                    ...
                    <div class="w-full flex flex-col justify-center">
                      ...
                      <div class="flex flex-row justify-between items-center">
                        <p class="text-xs text-gray-400">On projection apartments unsatiable...</p>
                        <div className="flex items-center justify-center bg-blue-500 animate-pulse rounded-full w-5 h-5 p-2">
                          <h1 class="text-sm text-center text-white font-bold">4</h1>
                        </div>
                      </div>
                    </div>
                  </li>
                  <li class="my-2 p-2 flex flex-row bg-blue-500 rounded-lg cursor-pointer" onClick={()=> navigate('/chat2')}>
                  ...
                  <li class="my-2 p-2 flex flex-row cursor-pointer rounded-lg hover:bg-gray-50 hover:bg-opacity-50" onClick={()=> navigate('/chat2')}>
                    ...
                    <div class="w-full flex flex-col justify-center">
                      ...
                      <div class="flex flex-row justify-between items-center">
                        <p class="text-xs text-gray-400">Sudden looked elinor off gay estate...</p>
                      </div>
                    </div>
                  </li>
                  <li class="my-2 p-2 flex flex-row cursor-pointer rounded-lg hover:bg-gray-50 hover:bg-opacity-50" onClick={()=> navigate('/chat2')}>
                    ...
                    <div class="w-full flex flex-col justify-center">
                      ...
                      <div class="flex flex-row justify-between items-center">
                        <p class="text-xs text-gray-400">Breakfast agreeable incommode depar...</p>
                      </div>
                    </div>
                  </li>
                  <li class="my-2 p-2 flex flex-row cursor-pointer rounded-lg hover:bg-gray-50 hover:bg-opacity-50" onClick={()=> navigate('/chat2')}>
                    ...
                    <div class="w-full flex flex-col justify-center">
                      ...
                      <div class="flex flex-row justify-between items-center">
                        <p class="text-xs text-gray-400">New the her nor case that lady paid...</p>
        ...
        {/* <!-- Middle section --> */}
        <div class="hidden w-[90%] blue-glassmorphism h-[89vh] overflow-y-auto scrollbar lg:flex flex-col justify-start items-stretch border-r-2 border-l-2 border-gray-100 lg:rounded-r-md xl:rounded-none">
          {/* <!-- Header with name --> */}
          <div class="flex flex-row items-center justify-between px-3 py-2 bg-gray-50 bg-opacity-40 border-b-2 border-gray-100">
            <div class="">
              ...
              <p class="text-xs text-gray-700">4 memebres</p>
            </div>
            <div class="flex flex-row">
              <button type="button" class="p-2 ml-2 text-gray-500 rounded-full hover:text-gray-600 hover:bg-gray-100 focus:outline-none focus:ring" aria-label="Search">
              ...
              <button type="button" class="p-2 ml-2 text-gray-500 xl:text-blue-500 rounded-full hover:text-gray-600 hover:bg-gray-100 focus:outline-none focus:ring" aria-label="Open">
              ...
              <button type="button" class="p-2 ml-2 text-gray-500 rounded-full hover:text-gray-600 hover:bg-gray-100 focus:outline-none focus:ring" aria-label="More">
                <svg class="w-6 h-6 fill-current" viewBox="0 0 24 24">
          ...
          {/* <!-- Messages --> */}
          <div class="flex-auto flex flex-col justify-between overflow-y-auto scrollbar-thin">
            <div class="flex flex-col">
              <div class="flex flex-row p-2 w-11/12">
                ...
                <div class="w-11/12 p-2">
                  <div class="bg-gray-50 bg-opacity-30 p-3 rounded-xl mb-2 relative">
                    <h2 class="text-sm font-semibold mb-2 text-gray-900">Yaeko Lindblom</h2>
                    <p class="text-sm text-gray-900">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                  ...
                  <div class="bg-gray-50 bg-opacity-30 p-3 rounded-xl mt-2 relative">
                    <h2 class="font-semibold mb-2 text-sm text-gray-900">Yaeko Lindblom</h2>
                    <p class="text-sm text-gray-900">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                    <span class="text-xs text-gray-400 absolute right-2 bottom-2">10:44</span>
                  </div>
                </div>
              </div>
        ...
        {/* <!-- Right section --> */}
        <div class="hidden w-4/6 h-[89vh] overflow-y-auto scrollbar-thin lg:block blue-glassmorphism rounded-r-md p-5 ">
          <header class="flex flex-row justify-end items-center">
            <button type="button" class="p-2 ml-2 relative bottom-2 text-gray-400 rounded-full hover:text-gray-600 hover:bg-gray-100 focus:outline-none focus:ring">
              <svg class="fill-current h-6 w-6" viewBox="0 0 20 20">
          ...
          <main>
            <div class="flex flex-col justify-center items-center my-1 sticky top-0">
            <div class="">
              <ul class="flex flex-row justify-between items-center bg-gray-50 bg-opacity-30 rounded-lg p-1">
                <li class="bg-white px-3 py-1 text-xs font-semibold rounded-md cursor-pointer">Media</li>
                <li class="text-xs text-gray-600 font-semibold px-3 py-1 cursor-pointer">Links</li>
                <li class="text-xs text-gray-600 font-semibold px-3 py-1 cursor-pointer">Files</li>
                <li class="text-xs text-gray-600 font-semibold px-3 py-1 cursor-pointer">Voice</li>
              </ul>
            ...
            <div class="my-6 ">
              <ul class="flex flex-row justify-center items-center relative bottom-10 ">
                <li>
            ...
            <div class="my-1 relative bottom-12">
              <ul>
                <li class="flex flex-row my-3 cursor-pointer group" onClick={()=> navigate('/chat3')}>
                  <div class="mr-4">
                  ...
                  <div class="flex flex-col justify-center">
                    <h2 class="text-sm font-bold text-gray-900 group-hover:text-gray-700">Jose Waldow</h2>
                    <p class="text-xs text-blue-600 font-normal group-hover:text-blue-500">Online</p>
                  </div>
                </li>
                <li class="flex flex-row my-3 cursor-pointer group" onClick={()=> navigate('/chat3')}>
                  <div class="mr-4">
                  ...
                  <div class="flex flex-col justify-center">
                    <h2 class="text-sm font-bold text-gray-900 group-hover:text-gray-700">Sherwood Rosol</h2>
                    <p class="text-xs text-blue-600 font-normal group-hover:text-blue-500">Online</p>
                  </div>
                </li>
                <li class="flex flex-row my-3 cursor-pointer group" onClick={()=> navigate('/chat3')}>
                  ...
                  <div class="flex flex-col justify-center">
                    <h2 class="text-sm font-bold text-gray-900 group-hover:text-gray-700">Leena Hannan</h2>
                    <p class="text-xs text-gray-400 font-normal group-hover:text-blue-500">last seen 40 minutes ago</p>
                  </div>
                </li>
                <li class="flex flex-row my-3 cursor-pointer group" onClick={()=> navigate('/chat3')}>
                  <div class="mr-4">
                  ...
                  <div class="flex flex-col justify-center">
                    <h2 class="text-sm font-bold group-hover:text-gray-700">Yaeko Lindblom</h2>
                    <p class="text-xs text-gray-400 font-normal group-hover:text-blue-500">last seen 40 minutes ago</p>
                  </div>
                </li>
              </ul>

...
const CustomerEmails = () => {
    ...
    const getCustEmails = () => {
      return axios.get('https://nartina.com/api/user/get-customer-emails/' + custid)
    }
    
    const {data, refetch} = useQuery('customer-emails', ()=> getCustEmails(),
      {
    ...
    const deleteEmail = () => {
      axios.delete("https://nartina.com/api/user/delete-customer-email/" + ide, {
        headers: {

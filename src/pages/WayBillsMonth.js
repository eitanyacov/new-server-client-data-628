...
import { Snackbar, Alert, PaginationItem, InputLabel } from "@mui/material";
...
//   const screen = window.screen.availWidth
  ...
  const getIncome = () => {
    const id = result?.id
    return axios.get("https://nartina.com/api/user/waybills-month/" + id)
  }
  
  const {data, refetch} = useQuery('current-month-waybills', ()=> getIncome(),
    {
      ...
      {hebrew ? (
       ...
       <div class="bg-white dark:bg-gray-800 shadow-md sm:rounded-lg">
           <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
               ...
               <button id="filterDropdownButton" data-dropdown-toggle="filterDropdown" class="w-full md:w-auto flex items-center justify-center py-2 px-4 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700" type="button">
                   ...
                   <div class="flex items-center space-x-3 w-full md:w-auto relative">
                       ...
                       <div className='hidden md:flex items-center justify-center space-x-2'>
                        ...
                        <h1 className='hidden md:inline font-mono font-semibold text-lg text-[#495057] dark:text-[#ccc]'>תעודות משלוח</h1>
               ...
               <h1 className='inline md:hidden text-center font-mono font-semibold text-lg text-[#333333] dark:text-[#ccc]'>תעודות משלוח</h1>
